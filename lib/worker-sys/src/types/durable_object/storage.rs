...
extern "C" {
    ...
    pub fn get_multiple(
        this: &DurableObjectStorage, keys: Vec<JsValue>,
    ) -> Result<js_sys::Promise, JsValue>;

    #[wasm_bindgen(method, catch)]
    pub fn put(
        this: &DurableObjectStorage, key: &str, value: JsValue,
    ) -> Result<js_sys::Promise, JsValue>;

    #[wasm_bindgen(method, catch, js_name=put)]
    pub fn put_multiple(
        this: &DurableObjectStorage, value: JsValue,
    ) -> Result<js_sys::Promise, JsValue>;
    ...
    pub fn list_with_options(
        this: &DurableObjectStorage, options: js_sys::Object,
    ) -> Result<js_sys::Promise, JsValue>;

    #[wasm_bindgen(method, catch)]
    pub fn transaction(
        this: &DurableObjectStorage, closure: &Closure<dyn FnMut(DurableObjectTransaction)>,
    ) -> Result<js_sys::Promise, JsValue>;
    ...
    pub fn set_alarm(
        this: &DurableObjectStorage, scheduled_time: js_sys::Date, options: js_sys::Object,
    ) -> Result<js_sys::Promise, JsValue>;
