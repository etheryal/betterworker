...
extern "C" {
    ...
    pub fn get_multiple(
        this: &DurableObjectTransaction, keys: Vec<JsValue>,
    ) -> Result<js_sys::Promise, JsValue>;

    #[wasm_bindgen(method, catch)]
    pub fn put(
        this: &DurableObjectTransaction, key: &str, value: JsValue,
    ) -> Result<js_sys::Promise, JsValue>;

    #[wasm_bindgen(method, catch, js_name=put)]
    pub fn put_multiple(
        this: &DurableObjectTransaction, value: JsValue,
    ) -> Result<js_sys::Promise, JsValue>;
    ...
    pub fn list_with_options(
        this: &DurableObjectTransaction, options: js_sys::Object,
    ) -> Result<js_sys::Promise, JsValue>;
