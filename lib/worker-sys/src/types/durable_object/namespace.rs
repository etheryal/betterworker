...
extern "C" {
    ...
    pub fn new_unique_id_with_options(
        this: &DurableObjectNamespace, options: &JsValue,
    ) -> Result<DurableObjectId, JsValue>;

    #[wasm_bindgen(method, catch)]
    pub fn get(
        this: &DurableObjectNamespace, id: &DurableObjectId,
