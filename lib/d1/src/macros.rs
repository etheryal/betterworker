/// Prepare a D1 query from the provided D1Database, query string, and optional
/// query parameters.
///
/// Any parameter provided is required to implement [`serde::Serialize`] to be
/// used.
///
/// Using [`query`] is equivalent to using db.prepare('').bind('') in
/// Javascript.
///
/// # Example
///
